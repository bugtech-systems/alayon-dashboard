...
export const usersTableConfig: DataTableConfig = {
  ...
  columns: [
    ...
    {
      id: "last_summary_date",
      accessorKey: "last_summary",
      header: "Last Summary",
      type: "date",
      sortable: true,
      filterable: true,
  ...
  filters: [
    ...
    },
    {
      ...
      label: "Admin Access",
      options: [
        { value: "true", label: "Admin Users" },
        { value: "false", label: "Non-Admin Users" },
      ],
    },
    {
      id: "user_role",
    ...
    },
    {
      ...
      placeholder: "Filter by commission rate",
    },
    {
      id: "date_range",
      field: "created_at",
    ...
    {
      id: "last_summary_range",
      field: "last_summary",
      type: "daterange",
      label: "Last Summary Date",
      placeholder: "Select last summary date range",
    },
    {
      id: "search_user",
      field: "search",
